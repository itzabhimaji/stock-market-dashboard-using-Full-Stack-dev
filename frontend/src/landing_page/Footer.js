...
function Footer() {
  return (
    <footer className="mt-5" style={{ backgroundColor: "rgb(240,240,240)" }}>
      ...
      <div className="mt-5 mt-5 mb-2 text-muted" style={{ fontSize: "14px" }}>
        <p>
          Zerodha Broking Ltd.: Member of NSE & BSE - SEBI Registration no.:
          INZ000031633 CDSL: Depository services through Zerodha Securities Pvt.
          Ltd. - SEBI Registration no.: IN-DP-100-2015 Trading through Zerodha
        ...
        <p>
          ...
          Address, Mobile Number, Email ID.Benefits: Effective communication,
        ...
        <p>
          ...
          authorise your bank to make payment in case of allotment. In case of
          non-allotment the funds will remain in your bank account.{" "}
        </p>
      </div>
    </footer>
  );
